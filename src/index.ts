...
(async() => {
    Logger.debug(`<OutageIdentifier> Outages which occured after ${outageBegin} will be processed for site: ${siteName}`);
    ...
    Logger.debug(`<OutageIdentifier> Outages reported successfully.`);
})()
